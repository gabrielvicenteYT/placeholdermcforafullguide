...
## Hacked Clients
Choosing hacked clients is a really difficult choice to make, so I made a hacked client tierlist, which can be found [here](https://github.com/gabrielvicenteYT/placeholdermcforafullguide/blob/main/docs/hacked_clients/TIERLIST.md).
